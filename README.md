...
## Часть №2
Этот проект представляет собой пример использования GitHub Actions для автоматизации сборки и тестирования Java-проекта с помощью Maven. После успешной сборки и прохождения тестов происходит оповещение о результате в чат Telegram.
![Пример работы бота](
