...
Также можно клонировать репозиторий `git clone https://github.com/RenataMal/Tech-Programming.git`. После того как клонирование завершено, перейдите в каталог репозитория `cd Tech-Programming`. После того как вы внутри клонированного репозитория, вы можете выполнить скрипт, указав его путь `./TZ1.sh`
