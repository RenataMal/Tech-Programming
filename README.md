...
Чтобы запустить данный скрипт, нужно его сохранить и запустить его в терминале в правильном каталоге. Также нужно проверить, имеет ли скрипт права на выполнение (chmod +x ...).
